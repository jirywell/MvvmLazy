...
public final class PathUtils {
    ...
    public static String getAppIntCachePath() {
        return GlobalUtils.getContext().getCacheDir().getAbsolutePath();
    }
    ...
    public static String getAppIntFilesPath() {
        return GlobalUtils.getContext().getFilesDir().getAbsolutePath();
    }
    ...
    public static String getAppIntDbPath(String name) {
        return GlobalUtils.getContext().getDatabasePath(name).getAbsolutePath();
    }
    ...
    public static String getAppExtCachePath() {
        return getFilePath(GlobalUtils.getContext().getExternalCacheDir());
    }
    ...
    public static String getAppExtFilePath() {
        return getFilePath(GlobalUtils.getContext().getExternalFilesDir(null));
    }
    ...
    public static String getAppExtAlarmsPath() {
        return getFilePath(GlobalUtils.getContext().getExternalFilesDir(Environment.DIRECTORY_ALARMS));
    }
    ...
    public static String getAppExtDCIMPath() {
        return getFilePath(GlobalUtils.getContext().getExternalFilesDir(Environment.DIRECTORY_DCIM));
    }
    ...
    public static String getAppExtDocumentsPath() {
        return getFilePath(GlobalUtils.getContext().getExternalFilesDir(Environment.DIRECTORY_DOCUMENTS));
    }
    ...
    public static String getAppExtDownloadPath() {
        return getFilePath(GlobalUtils.getContext().getExternalFilesDir(Environment.DIRECTORY_DOWNLOADS));
    }
    ...
    public static String getAppExtMoviesPath() {
        return getFilePath(GlobalUtils.getContext().getExternalFilesDir(Environment.DIRECTORY_MOVIES));
    }
    ...
    public static String getAppExtMusicPath() {
        return getFilePath(GlobalUtils.getContext().getExternalFilesDir(Environment.DIRECTORY_MUSIC));
    }
    ...
    public static String getAppExtNotificationsPath() {
        return getFilePath(GlobalUtils.getContext().getExternalFilesDir(Environment.DIRECTORY_NOTIFICATIONS));
    }
    ...
    public static String getAppExtPicturesPath() {
        return getFilePath(GlobalUtils.getContext().getExternalFilesDir(Environment.DIRECTORY_PICTURES));
    }
    ...
    public static String getAppExtPodcastsPath() {
        return getFilePath(GlobalUtils.getContext().getExternalFilesDir(Environment.DIRECTORY_PODCASTS));
    }
    ...
    public static String getAppExtRingtonesPath() {
        return getFilePath(GlobalUtils.getContext().getExternalFilesDir(Environment.DIRECTORY_RINGTONES));
    }
    ...
    public static String getObbPath() {
        return GlobalUtils.getContext().getObbDir().getAbsolutePath();
    }
    ...
    public static Uri getMediaContentUri(File mediaFile) {
        return getMediaContentUri(GlobalUtils.getContext(), mediaFile);
    }
    ...
    public static Uri getUriForFile(final File file) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            String authority = GlobalUtils.getContext().getPackageName() + ".GlobalUtils.provider";
            return FileProvider.getUriForFile(GlobalUtils.getContext(), authority, file);
        } else {
    ...
    public static Uri getUriByFilePath(final String filePath) {
        if (TextUtils.isEmpty(filePath))
            return null;
        return getUriByFile(new File(filePath));
    }
    ...
    public static Uri getUriByFile(final File file) {
        ...
        if (isScopedStorageMode() && isPublicPath(file)) {
            ...
            if (filePath.startsWith(PathConstants.EXT_DOWNLOADS_PATH)) {
                return getDownloadContentUri(GlobalUtils.getContext(), file);
            } else if (filePath.startsWith(PathConstants.EXT_PICTURES_PATH) || filePath.startsWith(PathConstants.EXT_DCIM_PATH)) {
                return getMediaContentUri(GlobalUtils.getContext(), file);
            } else {
    ...
    public static File uri2File(final Uri uri, final String columnName) {
        ...
        CursorLoader cl = new CursorLoader(GlobalUtils.getContext());
        cl.setUri(uri);
    ...
    public static String getFilePathByUri(Uri uri) {
        return getFilePathByUri(GlobalUtils.getContext(), uri);
    }
                ...
                if (split.length == 2) {
                    ...
                    if ("primary".equalsIgnoreCase(type)) {
                        ...
                        try {
                            ...
                            KLog.d("PathUtils", uri.toString() + " parse failed. " + ex.toString());
                        }
                    }
                }

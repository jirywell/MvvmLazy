 ...
 * *******************************
 */
public class CountDownTextView extends androidx.appcompat.widget.AppCompatTextView implements LifecycleObserver, View.OnClickListener {
...
//        autoBindLifecycle(context);
    ...
    public static String generateTime(long time) {
        ...
        if (day > 0) {
            format = String.format("%d天%02d:%02d:%02d", day, hours, minutes, seconds);
        } else if (hours > 0) {

...
public class ViewAdapter {
     ...
     */
    @BindingAdapter(value = {"itemValues", "valueReply", "resource", "dropDownResource", "onItemSelectedCommand"}, requireAll = false)
    public static void onItemSelectedCommand(Spinner spinner, List<IKeyAndValue> itemDatas, String valueReply, int resource, int dropDownResource, BindingCommand<IKeyAndValue> bindingCommand) {
        if (itemDatas == null) {
